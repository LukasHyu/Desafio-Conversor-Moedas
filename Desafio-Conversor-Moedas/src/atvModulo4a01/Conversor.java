...
public class Conversor implements ConversaoFinanceira {
    ...
    public void converterDolarToReal(){
        ...
        System.out.println("Convertendo o valor de $ " + this.getValorEmDolar() + " doláres, voce terá: R$ " + valorConvertido + " reais.");
